...
const Home = () => {
  return (
          ...
          messages.map((message,index)=>(
            ...
            <div className="p-1">
              <Card>
                ...
                <CardContent className="flex aspect-square items-center justify-center p-6 mr-8">
    ...
    <footer className='text-center p-4 md:p-6 bg-white text-black'>
      True FeedBack All Rights Reserved 
    </footer>
    </>
  )
}
